...
<div class="d-flex">
    <h2 class="my-5 me-5">
        <button class="btn ajouterepas bg-warning">
...
<div id="mail" class="mt-4">
    ...
    <button class="btn text-white" id="btnModifMail">
...
<div id="modificationMail" class="d-none ">
    <form method="POST" action="<?= URL; ?>compte/validation_modificationMail">
        <div class="row">
            ...
            <div class="col-2">
                <button class="btn " id="btnValidModifMail">
...
<div class=" mt-5">
    <a href="<?= URL ?>compte/modificationPassword" class="btn">Changer le mot de passe</a>
    <button id="btnSupCompte" class="btn mx-5">Supprimer mon compte</button>
</div>
